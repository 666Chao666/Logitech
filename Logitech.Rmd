...
We can see below, first of all, each family of products have a distinct sales 
...
such that the product is mainly circulating in markets in which holiday shopping
